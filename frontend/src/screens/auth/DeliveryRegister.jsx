...
const DeliveryRegister = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    if (!form.name || !form.email || !form.password || !form.gender || !form.vehicleType) {
  ...
  return (
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <TextInput style={styles.input} placeholder="Vehicle Type" value={form.vehicleType} onChangeText={v => handleChange('vehicleType', v)} />
